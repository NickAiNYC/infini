...
Multi-source research loops with citations.
...
Answer research questions with traceable citations across at least three primary sources.
...
2. Add `tags: [research]` to your Loopfile's metadata.
