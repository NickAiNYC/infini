...
Clinical research, claims audit, FDA workflows.
...
Audit clinical claims against guidelines, with escalation and signed audit trail.
...
2. Add `tags: [healthcare]` to your Loopfile's metadata.
