...
Audit, policy enforcement, regulatory workflows.
...
The canonical [`claim-audit-loop`](../loops/sre-loop/) loop is a
reference implementation for this category:

Audit claims against policy, with signed audit trails and escalation on low confidence.
...
2. Add `tags: [compliance]` to your Loopfile's metadata.
