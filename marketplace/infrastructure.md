...
SRE, oncall, deployment automation, migration.
...
The canonical [`migration-loop`](../loops/migration-loop/) loop is a
reference implementation for this category:

Migrate code across versions with behavior preservation and post-migration verification.

Run it:

```bash
infini install infini/migration-loop@1.0
...
2. Add `tags: [infrastructure]` to your Loopfile's metadata.
