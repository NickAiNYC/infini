...
Lesson planning, assessment, personalized tutoring.
...
The canonical [`content-loop`](../loops/content-loop/) loop is a
reference implementation for this category:

Draft lesson plans, critique against pedagogical rubric, revise until quality passes.

Run it:

```bash
infini install infini/content-loop@1.0
...
2. Add `tags: [education]` to your Loopfile's metadata.
