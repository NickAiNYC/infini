...
Outreach, prospecting, account research.
...
The canonical [`outreach-loop`](../loops/outreach-loop/) loop is a
reference implementation for this category:

Personalized outreach at scale, with personalization verification to prevent spam.

Run it:

```bash
infini install infini/outreach-loop@1.0
...
2. Add `tags: [sales]` to your Loopfile's metadata.
