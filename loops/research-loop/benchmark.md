...
Sample benchmark for `research-loop` on the INFINI Reference Engine.
...
```bash
infini benchmark loops/research-loop/Loopfile.yaml --engine hermes
infini benchmark loops/research-loop/Loopfile.yaml --engine openclaw
infini benchmark loops/research-loop/Loopfile.yaml --engine infini
