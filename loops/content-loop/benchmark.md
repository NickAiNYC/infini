# Benchmark — content-loop

Sample benchmark for `content-loop` on the INFINI Reference Engine.
...
```bash
infini benchmark loops/content-loop/Loopfile.yaml --engine hermes
infini benchmark loops/content-loop/Loopfile.yaml --engine openclaw
infini benchmark loops/content-loop/Loopfile.yaml --engine infini
