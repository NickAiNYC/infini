# Benchmark — outreach-loop

Sample benchmark for `outreach-loop` on the INFINI Reference Engine.
...
```bash
infini benchmark loops/outreach-loop/Loopfile.yaml --engine hermes
infini benchmark loops/outreach-loop/Loopfile.yaml --engine openclaw
infini benchmark loops/outreach-loop/Loopfile.yaml --engine infini
