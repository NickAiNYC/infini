# migration-loop — essay

> *Draft. PRs welcome.*

Migration loops are where teams lose weeks. The behavior-diff check is the floor; the migration_completeness semantic check is the ceiling. Both must pass before the loop ships.
