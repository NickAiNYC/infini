# Benchmark — migration-loop

Sample benchmark for `migration-loop` on the INFINI Reference Engine.
...
```bash
infini benchmark loops/migration-loop/Loopfile.yaml --engine hermes
infini benchmark loops/migration-loop/Loopfile.yaml --engine openclaw
infini benchmark loops/migration-loop/Loopfile.yaml --engine infini
